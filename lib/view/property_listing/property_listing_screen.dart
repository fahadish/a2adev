...
class _PropertyListingScreenState extends State<PropertyListingScreen> {
  PropertyListingController homeController = Get.put(PropertyListingController());
  int _currentIndex = 0;
                  ...
                  itemBuilder: (context, index) {
                    return InkWell(
                      ...
                      child: CustomCard(
                        borderRadius: 50..r,
                        color:
                            controller.selectedIndex != index ? AppColors.k0xffF8F8F8 : AppColors.k0xffE1C4FF,
                        topPadding: 7..h,
                        bottomPadding: 7,
                        leftPadding: 15,
                        rightPadding: 15,
                        enableBorder: true,
                        borderColor: controller.selectedIndex != index ? Colors.black : AppColors.k0xff3C1663,
                        borderWidth: controller.selectedIndex == index ? 2 : 1,
                        child: Row(
                          children: [
                            CustomText(text: "House", fontSize: 12..sp),
                            Image.asset("$iconPath/down.png", height: 20..h, width: 20..w)
                          ],
                        ),
                      ),
                    );
